...
def mainlist(item):
    logger.info("altadefinizione_press mainlist")
...
def categorias(item):
    logger.info("altadefinizione_press categorias")
    itemlist = []
...
def categorias_years(item):
    logger.info("altadefinizione_press categorias_years")
    itemlist = []
...
def categorias_quality(item):
    logger.info("altadefinizione_press categorias_quality")
    itemlist = []
...
def categorias_actors(item):
    logger.info("altadefinizione_press categorias_actors")
    itemlist = []
...
def search(item, texto):
    logger.info("altadefinizione_press " + item.url + " search " + texto)
...
def peliculas(item):
    logger.info("altadefinizione_press peliculas")
    itemlist = []
...
def findvideos(item):
    logger.info("altadefinizione_press findvideos")
    data = httptools.downloadpage(item.url, headers=headers).data
